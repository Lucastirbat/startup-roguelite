...
const FLAG_STORIES := {
	...
	"uncapped_safe": "You signed an uncapped SAFE. The cap turned out to be your optimism.",
	"rev_share": "The marina guy still collects 2% of revenue. Forever is a long time.",
	"party_round": "You raised a party round. Fourteen angels, zero leads, one Notion doc.",
	"venture_debt": "You took venture debt. The covenants had covenants.",
	"liq_pref": "The 2x liquidation preference came off the top. As designed.",
	"ratchet_terms": "Full-ratchet anti-dilution. It was on page 12. You skipped page 12.",
	"ipo_ratchet": "The IPO ratchet made them whole. With your shares.",
